...
func ValidateDigital_Ocean_ClusterVersion(spek Digital_Ocean_Clusterv1alpha1.Digital_Ocean_ClusterSpec) (bool, error) {
...
func getToken(sec string) (string, error) {
	...
	// konfig := flag.String("konfig", "/home/anutosh491/.kube/config", "location to your kubeconfig file")
